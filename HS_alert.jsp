...
<script type="text/javascript" src="prototype.js"></script>
   ...
   // String username = (String)session.getAttribute("username");
    ...
    String sql = "(select r.pid, r.oname ,r.rec_time,r.rvalue from recordings r,patient_specific_limits l where l.dname =(select dname from diagnosis where pid='"+username+"') and r.pid=l.pid and r.pid='P2' and r.rvalue<l.lowerlimit or r.rvalue>l.upperlimit and r.rec_time =(select max(rec_time) from recordings where pid='"+username+"'))";
...
<h1><b><font align="center"> ALERTS!!! </font></b></h1>
	<table width=600 align="center" cellspacing="40">
            <tr>
                <th> <h3> Patient Name</th>
                <th> <h3> Health Indicator</th>
                <th> <h3> Alert Type</th>
                ...
                <% 
        String obs_name=null,rec_time=null, pid=null;
        int rvalue = 0;
        ...
        while(rs.next())
        {
            ...
            <tr><td> <h3> <%=pid%> </td>
                ...
                <td> <h3> <%=rvalue%> </td>
                <td> <h3> <%=rec_time%> </td>
                <td> <h3> <form action="hs_alert_action.jsp" method="post"> <input type="submit" name="submit" value="Go"> </td>
                </table>
<form>
</form>
     <% }           
